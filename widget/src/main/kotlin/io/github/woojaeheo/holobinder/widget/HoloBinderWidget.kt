...
/** 오늘의 추천 카드 위젯 */
class HoloBinderWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        provideContent {
            HoloBinderWidgetContent(context, recommendation)
        }
    }
}

@Composable
private fun HoloBinderWidgetContent(
    context: Context,
    ...
    val openApp = actionStartActivity(
        ComponentName(
            "io.github.woojaeheo.holobinder",
            "io.github.woojaeheo.holobinder.MainActivity",
        ),
    )
    Row(
...
/** 위젯 수명 주기 연결 */
class HoloBinderWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = HoloBinderWidget()
